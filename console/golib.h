...
extern char* GetOrganizationAsJson(GoString p0);

extern struct organization* GetOrganizationAsCtype(GoString p0);

extern void FreeString(char* p0);

extern void FreeOrganizationAsCtype(struct organization* p0);
